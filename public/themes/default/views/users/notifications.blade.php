							...
							<ul class="list-group">
								<li href="#" class="list-group-item">
									<fieldset class="form-group">
										...
										{{ Form::select('email_follow', array('yes' => trans('common.yes'), 'no' => 'No'), $userSettings->email_follow, array('class' => 'form-control')) }}
									</fieldset>
								</li>
								<li href="#" class="list-group-item">
									<fieldset class="form-group">
										{{ Form::label('email_like_post', trans('common.label_email_like_post')) }}
										{{ Form::select('email_like_post', array('yes' => trans('common.yes'), 'no' => 'No'), $userSettings->email_like_post, array('class' => 'form-control')) }}
									</fieldset>
								</li>
								<li href="#" class="list-group-item">
									<fieldset class="form-group">
										{{ Form::label('email_post_share', trans('common.label_email_post_share')) }}
										{{ Form::select('email_post_share', array('yes' => trans('common.yes'), 'no' => 'No'), $userSettings->email_post_share, array('class' => 'form-control')) }}
									</fieldset>
								</li>
								<li href="#" class="list-group-item">
									<fieldset class="form-group">
