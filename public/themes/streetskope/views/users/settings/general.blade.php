					...
					<div class="socialite-form">
						<form method="POST" action="{{ url('/'.$username.'/settings/general/') }}">
							...
							<div class="row">
								<div class="col-md-6">
									<fieldset class="form-group">
										{{ Form::label('occupation', trans('common.occupation')) }}
										{{ Form::text('occupation', Auth::user()->occupation, ['class' => 'form-control', 'placeholder' => trans('common.occupation')]) }}
									</fieldset>
								</div>
								<div class="col-md-6">
									<fieldset class="form-group">
										{{ Form::label('aspiration', trans('common.aspiration')) }}
										{{ Form::text('aspiration', Auth::user()->aspiration, ['class' => 'form-control', 'placeholder' => trans('common.aspiration')]) }}
									</fieldset>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<fieldset class="form-group">
										{{ Form::label('supported_charity', trans('common.supported_charity')) }}
										{{ Form::text('supported_charity', Auth::user()->supported_charity, ['class' => 'form-control', 'placeholder' => trans('common.supported_charity')]) }}
									</fieldset>
								</div>
							</div>
