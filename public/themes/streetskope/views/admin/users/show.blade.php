            ...
            <table class="table existing-products-table socialite">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="#"><img src="{{ $timeline->user->profile_pict }}" alt="images"></a><a href="{{ url($timeline->username) }}"> {{ $timeline->name }}</a></td>
                        ...
                        <td>
                            <ul class="list-inline">
                                ...
                                <li><a href="{{ url('admin/users/'.$timeline->user->id.'/delete')}}" onclick="return confirm('{{ trans("messages.are_you_sure") }}')"><span class="trash-icon bg-danger"><i class="fa fa-trash" aria-hidden="true"></i></span></a></li>
                            </ul>
