...
?>
<ul class="list-unstyled main-comment comment{{ $comment->id }} {{ ($comment->replies()->count() > 0) ? 'has-replies' : '' }}" id="comment{{ $comment->id }}">    
    <li> 
            ...
            <div class="comments-list">
                <div class="commenter">
                    ...
                    <div class="commenter-name">
                        <a href="{{ url($comment->user->username) }}">{{ $comment->user->name }}</a><span class="comment-description">{{ $comment->description }}</span>
                    </div>
