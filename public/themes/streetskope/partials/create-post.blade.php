<form action="{{ url('') }}" method="post" class="create-post-form">
  {{ csrf_field() }}
    ...
    @if(isset($timeline_post))
        <div class="smallbubble-rtl"><img src="{{asset('themes/streetskope/assets/images/smallbubble-rtl.png')}}"></div>
    @else
        <div class="smallbubble"><img src="{{asset('themes/streetskope/assets/images/smallbubble.png')}}"></div>
    @endif
