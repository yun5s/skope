                    ...
                    <ul class="list-group new-events">
                        ...
                        <li class="list-group-item">
                            <a href="{{ url($group_event->timeline->username) }}" class="image-hover" data-toggle="tooltip" data-placement="top" title="{{ $group_event->timeline->name }}" >							
                                <img src=" @if($group_event->user->timeline->profile_pict) {{ url('user/avatar/'.$group_event->user->timeline->avatar->source) }} @else {{ url('group/avatar/default-group-avatar.png') }} @endif" alt="{{ $group_event->timeline->name }}" title="{{ $group_event->timeline->name }}">
                    ...
                    <ul class="list-group new-events">
                        ...
                        <li class="list-group-item">
                            <a href="{{ url($ongoing_event->timeline->username) }}" class="image-hover" data-toggle="tooltip" data-placement="top" title="{{ $ongoing_event->timeline->name }}" >
                                ...
                                <img src=" @if($ongoing_event->user->timeline->profile_pict) {{ url('user/avatar/'.$ongoing_event->user->timeline->avatar->source) }}  @else {{ url('group/avatar/default-group-avatar.png') }} @endif" alt="{{ $ongoing_event->timeline->name }}" title="{{ $ongoing_event->timeline->name }}">
                    ...
                    <ul class="list-group new-events">
                        ...
                        <li class="list-group-item">
                            <a href="{{ url($upcoming_event->timeline->username) }}" class="image-hover" data-toggle="tooltip" data-placement="top" title="{{ $upcoming_event->timeline->name }}" >
                                ...
                                <img src=" @if($upcoming_event->user->timeline->profile_pict) {{ url('user/avatar/'.$upcoming_event->user->timeline->avatar->source) }}  @else {{ url('group/avatar/default-group-avatar.png') }} @endif" alt="{{ $upcoming_event->timeline->name }}" title="{{ $upcoming_event->timeline->name }}">
