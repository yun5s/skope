                        ...
                        <div class="row message-box">
                            <div class="col-md-4 col-sm-4 col-xs-4 message-col-4">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="<?php echo e(trans('common.search')); ?>">
                                ...
                                <div class="coversation-tree">
                                    <div class="conversation">
                                        ...
                                        <div class="new-conversation" v-if="newConversation">
                                            <input type="text" v-model="recipients" name="recipients[]" class="form-control" id="messageReceipient" placeholder="<?php echo e(trans('messages.search_people_placeholder')); ?>">
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
...
<?php echo Theme::asset()->container('footer')->usePath()->add('messages-js', 'js/messages.js'); ?>