<div class="timeline-cover-section">
	...
	<div class="timeline-list">
		...
		<div class="timeline-user-avtar">
			<?php if(strpos($timeline->user->avatar, '/image') !== false): ?>
				<img id="modal-image-1" src="<?php echo e($timeline->user->avatar); ?>" alt="<?php echo e($timeline->name); ?>" title="<?php echo e($timeline->name); ?>">
			<?php else: ?>
				<img id="modal-image-2" src="<?php echo e($timeline->user->avatar); ?>" data-video="<?php echo e($timeline->user->avatar_video); ?>" alt="<?php echo e($timeline->name); ?>" title="<?php echo e($timeline->name); ?>">
			<?php endif; ?>
			<?php if($timeline->id == Auth::user()->timeline_id): ?>
