<div class="widget-events widget-left-panel">
	<div class="menu-list">
		<ul class="list-unstyled">
			...
			<li><a href="<?php echo e(url(Auth::user()->username.'/pages-groups')); ?>" class="btn menu-btn"><i class="fa fa-file-text" aria-hidden="true"></i><?php echo e(trans('common.pages')); ?> <span class="event-circle"><?php echo e(Auth::user()->own_pages()->count()); ?></span></a></li>

			<li><a href="<?php echo e(url(Auth::user()->username.'/pages-groups')); ?>" class="btn menu-btn"><i class="fa fa-group" aria-hidden="true"></i><?php echo e(trans('common.groups')); ?> <span class="event-circle"><?php echo e(Auth::user()->own_groups()->count()); ?></span></a></li>
