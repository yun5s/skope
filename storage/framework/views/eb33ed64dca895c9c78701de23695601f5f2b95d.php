...
<div class="panel panel-default panel-post animated" id="post<?php echo e($post->id); ?>">
    ...
    <div class="panel-body">
        ...
        <ul class="actions-count list-inline">
            ...
            <?php /*<?php if($post->users_liked()->wherePivot('liked', 1)->count() > 0): ?>*/ ?>
                <?php
                $liked_ids = $post->users_liked->pluck('id')->toArray();
                $liked_names = $post->users_liked->pluck('name')->toArray();
                ?>
                <?php /*<li>*/ ?>
                    <?php /*<a href="#" class="show-users-modal" data-html="true" data-heading="<?php echo e(trans('common.likes')); ?>"  data-users="<?php echo e(implode(',', $liked_ids)); ?>" data-original-title="<?php echo e(implode('<br />', $liked_names)); ?>"><span class="count-circle"><i class="fa fa-thumbs-up"></i></span> <?php echo e($post->users_liked()->wherePivot('liked', 1)->count()); ?> <?php echo e(trans('common.likes')); ?></a>*/ ?>
                <?php /*</li>*/ ?>
            <?php /*<?php endif; ?>*/ ?>

            <?php /*<?php if($post->users_liked()->wherePivot('liked', 0)->count() > 0): ?>*/ ?>
                <?php
                $unliked_ids = $post->users_liked->pluck('id')->toArray();
                $unliked_names = $post->users_liked->pluck('name')->toArray();
                ?>
                <?php /*<li>*/ ?>
                    <?php /*<a href="#" class="show-users-modal" data-html="true" data-heading="<?php echo e(trans('common.unlikes')); ?>"  data-users="<?php echo e(implode(',', $unliked_ids)); ?>" data-original-title="<?php echo e(implode('<br />', $unliked_names)); ?>"><span class="count-circle"><i class="fa fa-thumbs-down"></i></span> <?php echo e($post->users_liked()->wherePivot('liked', 0)->count()); ?> <?php echo e(trans('common.unlikes')); ?></a>*/ ?>
                <?php /*</li>*/ ?>
            <?php /*<?php endif; ?>*/ ?>
    ...
    <div class="panel-footer socialite">
        <ul class="list-inline footer-list">
            <?php if($post->users_liked->contains(Auth::user()->id)): ?>
                <?php if($post->users_liked()->wherePivot('user_id', Auth::user()->id)->wherePivot('liked', 1)->first()): ?>
                    <li><a href="#" class="like-post like-<?php echo e($post->id); ?> active" data-post-id="<?php echo e($post->id); ?>"><i class="fa fa-thumbs-up"></i><?php echo e(trans('common.like')); ?></a></li>

                    <li><a href="#" class="unlike-post unlike-<?php echo e($post->id); ?>" data-post-id="<?php echo e($post->id); ?>"><i class="fa fa-thumbs-o-down"></i></i><?php echo e(trans('common.unlike')); ?></a></li>
                ...
                <?php else: ?>
                    ...
                    <li><a href="#" class="unlike-post unlike-<?php echo e($post->id); ?> active" data-post-id="<?php echo e($post->id); ?>"><i class="fa fa-thumbs-down"></i></i><?php echo e(trans('common.unlike')); ?></a></li>
                <?php endif; ?>
            <?php else: ?>
                <li><a href="#" class="like-post like-<?php echo e($post->id); ?>" data-post-id="<?php echo e($post->id); ?>"><i class="fa fa-thumbs-o-up"></i><?php echo e(trans('common.like')); ?></a></li>
                <li><a href="#" class="unlike-post unlike-<?php echo e($post->id); ?>" data-post-id="<?php echo e($post->id); ?>"><i class="fa fa-thumbs-o-down"></i></i><?php echo e(trans('common.unlike')); ?></a></li>
