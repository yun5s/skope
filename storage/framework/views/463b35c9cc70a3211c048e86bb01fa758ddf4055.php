<form action="<?php echo e(url('')); ?>" method="post" class="create-post-form">
  <?php echo e(csrf_field()); ?>
    ...
    <?php if(isset($timeline_post)): ?>
        <div class="smallbubble-rtl"><img src="<?php echo e(asset('themes/streetskope/assets/images/smallbubble-rtl.png')); ?>"></div>
    <?php else: ?>
        <div class="smallbubble"><img src="<?php echo e(asset('themes/streetskope/assets/images/smallbubble.png')); ?>"></div>
    <?php endif; ?>
