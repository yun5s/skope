					...
					<div class="socialite-form">
						<form method="POST" action="<?php echo e(url('/'.$username.'/settings/general/')); ?>">
							...
							<div class="row">
								<div class="col-md-6">
									<fieldset class="form-group">
										<?php echo e(Form::label('age', trans('common.age'))); ?>

										<?php echo e(Form::number('age', Auth::user()->age, ['class' => 'form-control', 'placeholder' => trans('common.age')])); ?>
								...
								<div class="col-md-6">
									<fieldset class="form-group">
										...
										<?php echo e(Form::text('location', Auth::user()->designation, ['class' => 'form-control', 'placeholder' => trans('common.location')])); ?>
							...
							<div class="row">
								<div class="col-md-6">
									<fieldset class="form-group">
										<?php echo e(Form::label('occupation', trans('common.occupation'))); ?>

										<?php echo e(Form::text('occupation', Auth::user()->occupation, ['class' => 'form-control', 'placeholder' => trans('common.occupation')])); ?>

									</fieldset>
								</div>
								<div class="col-md-6">
									<fieldset class="form-group">
										<?php echo e(Form::label('aspiration', trans('common.aspiration'))); ?>

										<?php echo e(Form::text('aspiration', Auth::user()->aspiration, ['class' => 'form-control', 'placeholder' => trans('common.aspiration')])); ?>
							...
							<div class="row">
								<div class="col-md-6">
									<fieldset class="form-group">
										<?php echo e(Form::label('role_model', trans('common.role_model'))); ?>

										<?php echo e(Form::text('role_model', Auth::user()->role_model, ['class' => 'form-control', 'placeholder' => trans('common.role_model')])); ?>

									</fieldset>
								</div>
								<div class="col-md-6">
									<fieldset class="form-group">
										<?php echo e(Form::label('my_network', trans('common.my_network'))); ?>

										<?php echo e(Form::text('my_network', Auth::user()->my_network, ['class' => 'form-control', 'placeholder' => trans('common.my_network')])); ?>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<fieldset class="form-group">
										<?php echo e(Form::label('supported_charity', trans('common.supported_charity'))); ?>

										<?php echo e(Form::text('supported_charity', Auth::user()->supported_charity, ['class' => 'form-control', 'placeholder' => trans('common.supported_charity')])); ?>
