...
<html lang="es">
    <head>
        ...
        <link href="<?php echo e(asset('themes/'.\App\Setting::get('current_theme', 'default').'/assets/css/img-modal.css')); ?>">
    ...
    <body <?php if(Setting::get('enable_rtl') == 'on'): ?> class="direction-rtl" <?php endif; ?>>
        ...
        <script type="text/javascript" src="<?php echo e(asset('themes/'.\App\Setting::get('current_theme', 'default').'/assets/js/img-modal.js')); ?>"></script>
    </body>
</html>
