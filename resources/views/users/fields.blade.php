...
<!-- Timeline Id Field -->
<div class="form-group col-sm-6">
    {!! Form::label('timeline_id', 'Timeline Id:') !!}
    {!! Form::number('timeline_id', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('email_verified', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Last Logged Field -->
<div class="form-group col-sm-6">
    {!! Form::label('last_logged', 'Last Logged:') !!}
    {!! Form::date('last_logged', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Referral Id Field -->
<div class="form-group col-sm-6">
    {!! Form::label('referral_id', 'Referral Id:') !!}
    {!! Form::number('referral_id', null, ['class' => 'form-control']) !!}
</div>
