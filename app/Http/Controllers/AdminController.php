...
class AdminController extends Controller
{
    ...
    {        
        ...
        {            
            ...
            {          
                $messages = 'Email details are not configured in .env file, please turn OFF email verification for now.';
                return redirect()->back()->with('messages', 'Email details are not configured in .env file, please turn OFF email verification for now.');
            }            
        }
        ...
        {           
            ...
            {          
                $messages = 'Captcha details are not configured in .env file, please turn OFF captcha for now.';
                return redirect()->back()->with('messages', 'Captcha details are not configured in .env file, please turn OFF captcha for now.');
    ...
    {       
        ...
        {   
            ...
            if($sort_type == 'likes_asc' || $sort_type == 'likes_desc')  
            {
                ...
                $timelines= new LengthAwarePaginator($currentPageSearchResults, count($collection), $perPage, Paginator::resolveCurrentPage(), 
